...
try:
    ...
    exec(open("/home/ashu/Desktop/internship/CADSmith-Original/outputs/test_part_iter0_script.py").read(), _autofab_user_globals)
    ...
    if _autofab_result is None:
        ...
        # Export STEP and STL
        cq.exporters.export(_autofab_result, "/home/ashu/Desktop/internship/CADSmith-Original/outputs/test_part_iter0.step")
        cq.exporters.export(_autofab_result, "/home/ashu/Desktop/internship/CADSmith-Original/outputs/test_part_iter0.stl")
